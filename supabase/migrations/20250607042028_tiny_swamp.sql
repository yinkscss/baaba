/*
  # Create inspection requests and escrow transactions tables
  ...
  1. New Tables
    ...
    - `escrow_transactions`
      ...
      - `amount` (numeric, check constraint)
      - `status` (text, check constraint)
  ...
  2. Security
    ...
    - Add policies for tenants and landlords to manage their respective data
