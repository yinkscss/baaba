...
import { CreditCard, Search, Filter, DollarSign, Clock, CheckCircle, XCircle } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-4">
        ...
        <select
          className="rounded-md border border-nav bg-background px-4 py-2 text-text-primary"
          value={dateFilter}
          onChange={(e) => setDateFilter(e.target.value as 'all' | 'thisMonth' | 'lastMonth')}
        >
